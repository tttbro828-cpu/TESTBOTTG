...
CASES = {
    ...
    "Галактический кейс": {
        ...
        "rewards": [
            {"type": "exp", "value": 50000, "chance": 30, "name": "50000 опыта"},
            {"type": "exp", "value": 100000, "chance": 25, "name": "100000 опыта"},
            {"type": "buff", "value": "Золотая пуля", "count": 25, "chance": 20, "name": "💫 Золотая пуля x25"},
            {"type": "buff", "value": "Алмазная пуля", "count": 15, "chance": 23, "name": "💎 Алмазная пуля x15"},
...
QUESTS = {
    ...
    "quest_vulkan": {
        ...
        "story": "Старейшина говорит: «В Инферно живёт дух огня. Принеси доказательство — 100 убийств в Инферно.»",
        "type": "weapon",
        "condition_type": "location_kills",
        "condition_value": ("Инферно", 100),
        "reward_coins": 0,
        "reward_exp": 0,
        "reward_title": None,
    ...
    "quest_adsky": {
        "name": "🔥 Адский вызов",
        "story": "Старейшина говорит: «Сам чёрт боится этого оружия. Убей 50 в Инферно.»",
        "type": "weapon",
        "condition_type": "location_kills",
        "condition_value": ("Инферно", 50),
        "reward_coins": 0,
        "reward_exp": 0,
        "reward_title": None,
    ...
    "quest_ledyanoy": {
        ...
        "story": "Старейшина говорит: «В Арктике холод не убивает. Убей 100 там.»",
        "type": "weapon",
        "condition_type": "location_kills",
        "condition_value": ("Арктика", 100),
        "reward_coins": 0,
        "reward_exp": 0,
        "reward_title": None,
    ...
    "quest_severny": {
        ...
        "story": "Старейшина говорит: «Ветер шепчет: стреляй. Убей 50 в Грозовой бездне.»",
        "type": "weapon",
        "condition_type": "location_kills",
        "condition_value": ("Грозовая бездна", 50),
        "reward_coins": 0,
        "reward_exp": 0,
        "reward_title": None,
    ...
    "quest_yadovity": {
        "name": "🧪 Ядовитый след",
        "story": "Старейшина говорит: «Джунгли полны яда. Убей 100 там.»",
        "type": "weapon",
        "condition_type": "location_kills",
        "condition_value": ("Джунгли", 100),
        "reward_coins": 0,
        "reward_exp": 0,
        "reward_title": None,
    ...
    "quest_skorpion": {
        "name": "🦂 Убийца титанов",
        "story": "Старейшина говорит: «30 титанов — и ты легенда.»",
        "type": "weapon",
        "condition_type": "titan_kills",
        "condition_value": 30,
        "reward_coins": 0,
    ...
    "quest_podvodny": {
        ...
        "story": "Старейшина говорит: «Электричество в воде. Убей 100 в Подводном мире.»",
        "type": "weapon",
        "condition_type": "location_kills",
        "condition_value": ("Подводный мир", 100),
        "reward_coins": 0,
        "reward_exp": 0,
        "reward_title": None,
    ...
    "quest_ten_lesa": {
        "name": "🌑 Тень леса",
        "story": "Старейшина говорит: «Призрачный лес хранит тайны. Убей 100 там.»",
        "type": "weapon",
        "condition_type": "location_kills",
        "condition_value": ("Призрачный лес", 100),
        "reward_coins": 0,
        "reward_exp": 0,
        "reward_title": None,
    ...
    "quest_drevnyaya_krov": {
        "name": "🦖 Древняя кровь",
        "story": "Старейшина говорит: «Древний мир — колыбель. Убей 30 титанов там.»",
        "type": "weapon",
        "condition_type": "location_kills",
        "condition_value": ("Древний мир", 30),
        "reward_coins": 0,
        "reward_exp": 0,
        "reward_title": None,
    ...
    "quest_angelskoe": {
        ...
        "story": "Старейшина говорит: «Свет против тьмы. Убей 100 в Инферно.»",
        "type": "weapon",
        "condition_type": "location_kills",
        "condition_value": ("Инферно", 100),
        "reward_coins": 0,
    ...
    "quest_bozhestvenny": {
        ...
        "story": "Старейшина говорит: «Боги наблюдают. Убей 50 титанов.»",
        "type": "weapon",
        "condition_type": "titan_kills",
        "condition_value": 50,
        "reward_coins": 0,
    ...
    "quest_galactic_license": {
        ...
        "story": "Старейшина говорит: «Галактический кейс — это легенда. Чтобы получить доступ, докажи, что ты достоин. Убей 100 титанов, собери 10,000 осколков и накопи 1,000,000 монет.»",
        "type": "license",
        "condition_type": "galactic_license",
...
UPGRADES_CONFIG = {
    ...
    "traps": {
        ...
        "levels": {
            ...
            3: {"price": 30000, "dangerous": 10, "heavy": 2},
            4: {"price": 60000, "heavy": 3, "titan": 0.5}
        }
    },
    "ballistics": {
        "name": "🔫 Баллистика",
        ...
        "levels": {
            ...
            5: {"price": 200000, "damage_titan": 5, "hit_titan": 4}
        }
    },
    "tactics": {
        "name": "🏃 Тактика",
    ...
    "trophies": {
        ...
        "levels": {
            ...
            5: {"price": 100000, "collectible_all": 5}
        }
    }
}
...
def get_upgrade_price(user_id: int, group: str) -> int:
    ...
    return UPGRADES_CONFIG[group]["levels"][next_level]["price"]
...
def can_upgrade(user_id: int, group: str) -> tuple:
    ...
    next_level = current_level + 1
    price = UPGRADES_CONFIG[group]["levels"][next_level]["price"]
    
    user = ensure_user(user_id)
    if user[1] < price:
        return False, f"❌ Не хватает {price - user[1]} монет!"
    
    return True, f"✅ Можно улучшить за {price} монет"
...
def can_buy_case(user_id: int, case_name: str) -> tuple:
    ...
    # Проверка монет
    if case_data.get("price_coins", 0) > 0 and user[1] < case_data["price_coins"]:
        return False, f"❌ Не хватает {case_data['price_coins'] - user[1]} монет"
...
def buy_case(user_id: int, case_name: str) -> tuple:
    ...
    # Списываем монеты
    if case_data.get("price_coins", 0) > 0:
        cur.execute("UPDATE users SET coins = coins - ? WHERE user_id = ?", 
                   (case_data["price_coins"], user_id))
...
def get_user_health(user_id: int):
    ...
    # Текущее здоровье
    user = cur.execute("SELECT health FROM users WHERE user_id = ?", (user_id,)).fetchone()
    current_hp = user[0] if user else 150
    
    # Уровень безопасности (safety)
...
@dp.message(lambda msg: msg.text and msg.text.lower() == "дипспилис")
...
async def simple_shot(call: CallbackQuery, user_id: int, group: str, animal_name: str, weapon: str, location: str, sneak_bonus: int = 0, animal_group: str = None):
    ...
    if random.randint(1, 100) <= collectible_chance:        if location in LOCATION_COLLECTIBLES and group in LOCATION_COLLECTIBLES[location]:
...
async def inventory(msg: Message):
    ...
    # ===== УЛУЧШЕНИЯ (всё суммируется) =====
    upgrades_str = get_all_upgrades_bonuses(msg.from_user.id)
    
    # Добавляем бонусы ранга
    rank_bonuses = []
    if rank["bonus_exp"] > 0:
        rank_bonuses.append(f"+{rank['bonus_exp']}% к опыту")
    if rank["bonus_coins"] > 0:
        rank_bonuses.append(f"+{rank['bonus_coins']}% к монетам")
    
    if rank_bonuses:
        if upgrades_str == "нет":
            upgrades_str = ", ".join(rank_bonuses)
        else:
            upgrades_str += ", " + ", ".join(rank_bonuses)
    
    message_lines.append(f"🔧 Улучшения: {upgrades_str}")    
    text = "\n".join(message_lines)
    await msg.answer(text)
...
async def cust_titles(call: CallbackQuery):
    ...
    if not available_ids:
        await call.message.edit_text("👑 У вас пока нет титулов. Выполняйте задания старейшины!")
        return
...
async def upgrades_menu(call: CallbackQuery):
    ...
    for group_key, group_data in UPGRADES_CONFIG.items():
        ...
        price = get_upgrade_price(user_id, group_key)
        
        if current_level >= max_level:
            status = "✅ MAX"
        else:
            status = f"📈 {current_level}/{max_level} — {price}💰"
...
async def upgrade_info(call: CallbackQuery):
    ...
    next_price = get_upgrade_price(user_id, group_key)
    ...
    if current_level < max_level:
        buttons.append([InlineKeyboardButton(
            text=f"⬆️ Улучшить до {current_level + 1} уровня за {next_price}💰",
...
async def main():
   ...
   # migrate_old_trophies()
    ...
    # max_hp теперь считается из улучшений "Безопасность"
