...
WEAPONS_FIRE = {
    ...
    "Пирокинетический карабин": {"damage": 45, "chances": [25,45,40,12,5], "level_req": 25, "group": "огненные", "ability": "ignite", "ability_desc": "Воспламенение: животное не атакует 1 ход", "ability_chance": 50, "description": "Мыслишь огнём? Оно стреляет огнём. Идеальное попадание", "obtain": {"type": "craft", "requirement": "скоро"}},
    "Дыхание дракона": {"damage": 55, "chances": [55,35,10,2,0.5], "level_req": 25, "group": "огненные", "ability": "fire_wave", "ability_desc": "Огненный вал: урон по всем частям", "ability_chance": 50, "description": "Один выдох — и лес позади тебя превращается в пепел. Драконы одобряют", "obtain": {"type": "case", "requirement": "редкий кейс (скоро)"}},
    ...
    "Феникс-винтовка": {"damage": 48, "chances": [25,35,50,60,52], "level_req": 25, "group": "огненные", "ability": "rebirth", "ability_desc": "Возрождение: 1 раз воскреснуть", "ability_chance": 50, "description": "Сгорает дотла после каждого выстрела. И возрождается. У неё больше жизней, чем у кота", "obtain": {"type": "craft", "requirement": "редкий крафт (скоро)"}},
}
...
WEAPONS_ICE = {
    ...
    "Ледяная винтовка": {"damage": 40, "chances": [20,55,25,8,2], "level_req": 50, "group": "ледяные", "ability": "ice_shard", "ability_desc": "Сосулька: x1.5 урона при попадании", "ability_chance": 50, "description": "Ствол покрыт инеем. Даже в руках холодно. А уж зверям — тем более", "obtain": {"type": "craft", "requirement": "скоро"}},
    ...
    "Морозный посох": {"damage": 35, "chances": [25,45,40,15,5], "level_req": 50, "group": "ледяные", "ability": "icicle", "ability_desc": "Ледяной кристалл: гарант крита по замороженному", "ability_chance": 50, "description": "Маг из отдела кадров зачаровал. Теперь это не посох, а морозилка", "obtain": {"type": "case", "requirement": "скоро"}},
    ...
    "Вечная мерзлота": {"damage": 50, "chances": [8,18,38,62,20], "level_req": 50, "group": "ледяные", "ability": "permafrost", "ability_desc": "Ледяная глыба: -20% брони животного", "ability_chance": 50, "description": "Говорят, время лечит. Это оружие — лечит время. Замораживает навсегда", "obtain": {"type": "craft", "requirement": "редкий крафт (скоро)"}},
}
...
WEAPONS_POISON = {
    ...
    "Змеиный клык": {"damage": 35, "chances": [22,58,22,6,1.5], "level_req": 100, "group": "ядовитые", "ability": "paralyze", "ability_desc": "Паралич: животное не двигается 2 хода", "ability_chance": 50, "description": "Змея кусает раз. А тут — каждый выстрел как укус. И яд тот же", "obtain": {"type": "craft", "requirement": "скоро"}},
    ...
    "Некротический арбалет": {"damage": 40, "chances": [12,32,58,28,9], "level_req": 100, "group": "ядовитые", "ability": "decay", "ability_desc": "Гниение: -12 HP/ход (3 хода)", "ability_chance": 50, "description": "Мёртвые не кусаются. Они просто гниют. И твой враг — не исключение", "obtain": {"type": "case", "requirement": "редкий кейс (скоро)"}},
    ...
    "Бактериальная винтовка": {"damage": 42, "chances": [28,38,48,58,50], "level_req": 100, "group": "ядовитые", "ability": "epidemic", "ability_desc": "Эпидемия: яд передаётся следующему", "ability_chance": 50, "description": "Чихать на зверей — буквально. Они подхватят заразу и разнесут дальше", "obtain": {"type": "craft", "requirement": "редкий крафт (скоро)"}},
}
...
WEAPONS_ELECTRIC = {
    ...
    "Громовой карабин": {"damage": 40, "chances": [28,48,44,15,7], "level_req": 200, "group": "электрические", "ability": "chain_lightning", "ability_desc": "Цепная молния: +15% урона соседнему", "ability_chance": 50, "description": "Гром среди ясного неба. И молния — туда же", "obtain": {"type": "craft", "requirement": "скоро"}},
    ...
    "Плазменная винтовка": {"damage": 45, "chances": [22,55,28,10,4], "level_req": 200, "group": "электрические", "ability": "charged_shot", "ability_desc": "Заряженный выстрел: x1.5 урона", "ability_chance": 50, "description": "Плазма не оставляет шансов. И улик — тоже", "obtain": {"type": "case", "requirement": "эпический кейс (скоро)"}},
    ...
    "Грозовой револьвер": {"damage": 38, "chances": [48,20,8,2,0.3], "level_req": 200, "group": "электрические", "ability": "thunder_strike", "ability_desc": "Удар молнии: гарант попадания", "ability_chance": 50, "description": "Боги грома одобряют. Они даже скинулись на покупку", "obtain": {"type": "craft", "requirement": "редкий крафт (скоро)"}},
}
...
WEAPONS_DARK = {
    ...
    "Кошмарный карабин": {"damage": 42, "chances": [25,45,42,15,7], "level_req": 350, "group": "тёмные", "ability": "fear", "ability_desc": "Страх: убегает с наградой", "ability_chance": 50, "description": "Зверю снится кошмар. Твой выстрел. И ты в главной роли", "obtain": {"type": "craft", "requirement": "скоро"}},
    "Душелов": {"damage": 35, "chances": [48,20,8,2,0.2], "level_req": 350, "group": "тёмные", "ability": "soul_steal", "ability_desc": "Кража души: +20% урона до конца", "ability_chance": 50, "description": "Ловит не только зверей. Иногда — и удачу за хвост", "obtain": {"type": "case", "requirement": "эпический кейс (скоро)"}},
    ...
    "Проклятый мушкет": {"damage": 55, "chances": [8,18,38,62,24], "level_req": 350, "group": "тёмные", "ability": "curse", "ability_desc": "Проклятие: x2 урона в след. ход", "ability_chance": 50, "description": "Ствол изогнут, приклад треснут. Но стреляет так, что предки в гробу переворачиваются", "obtain": {"type": "craft", "requirement": "редкий крафт (скоро)"}},
}
...
WEAPONS_HOLY = {
    ...
    "Паладин-пистолет": {"damage": 38, "chances": [60,38,12,3,0.4], "level_req": 500, "group": "священные", "ability": "faith_shield", "ability_desc": "Щит веры: нет урона 1 ход", "ability_chance": 50, "description": "Бог на твоей стороне. И в стволе — тоже", "obtain": {"type": "craft", "requirement": "скоро"}},
    "Небесный карабин": {"damage": 40, "chances": [28,48,44,16,8], "level_req": 500, "group": "священные", "ability": "light", "ability_desc": "Свет: снимает проклятия", "ability_chance": 50, "description": "Стреляет радугой. Звери умирают от счастья", "obtain": {"type": "case", "requirement": "легендарный кейс (скоро)"}},
    ...
    "Экзорцист": {"damage": 60, "chances": [10,20,40,65,27], "level_req": 500, "group": "священные", "ability": "exorcism", "ability_desc": "Изгнание: 20% убить нежить/демонов", "ability_chance": 50, "description": "Святой водой не обойтись. Придётся стрелять. Много стрелять", "obtain": {"type": "craft", "requirement": "легендарный крафт (скоро)"}},
}
...
async def battle_sneak(call: CallbackQuery):
    ...
    if group in ["Мелочь", "Средн"]:
        await simple_shot(call, user_id, group, animal_name, weapon, location, 10, animal_group)
        return
...
async def simple_shot(call: CallbackQuery, user_id: int, group: str, animal_name: str, weapon: str, location: str, sneak_bonus: int = 0, animal_group: str = None):
    ...
    await call.message.edit_text(
        ...
        f"💰 +{coins} монет\n"
        f"⭐ +{exp} опыта{event_msg}{collectible_msg}"
    )
...
async def battle_attack(call: CallbackQuery):
    ...
    if new_animal_hp <= 0:
        ...
        await call.message.edit_text(
            f"🎯 **ПОБЕДА!**\n\n"
            f"🐾 {animal_name}{mutation_text} повержен!\n"
            f"💰 +{coins} монет\n"
            f"⭐ +{exp} опыта{event_msg}{collectible_msg}"
        )
        return
